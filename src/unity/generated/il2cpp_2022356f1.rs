...
pub mod CIl2Cpp {
    ...
    pub struct __locale_struct {
        pub __locales: [*mut CIl2Cpp::__locale_data; 13usize],
    ...
    pub type __locale_t = *mut CIl2Cpp::__locale_struct;
    pub type locale_t = CIl2Cpp::__locale_t;
    #[repr(C)]
    #[repr(align(16))]
    ...
    pub type __int_least8_t = CIl2Cpp::__int8_t;
    pub type __uint_least8_t = CIl2Cpp::__uint8_t;
    pub type __int_least16_t = CIl2Cpp::__int16_t;
    pub type __uint_least16_t = CIl2Cpp::__uint16_t;
    pub type __int_least32_t = CIl2Cpp::__int32_t;
    pub type __uint_least32_t = CIl2Cpp::__uint32_t;
    pub type __int_least64_t = CIl2Cpp::__int64_t;
    pub type __uint_least64_t = CIl2Cpp::__uint64_t;
    ...
    pub type __loff_t = CIl2Cpp::__off64_t;
    pub type __caddr_t = *mut ::std::os::raw::c_char;
    pub type __intptr_t = ::std::os::raw::c_long;
    pub type __socklen_t = ::std::os::raw::c_uint;
    pub type __sig_atomic_t = ::std::os::raw::c_int;
    pub type int_least8_t = CIl2Cpp::__int_least8_t;
    pub type int_least16_t = CIl2Cpp::__int_least16_t;
    pub type int_least32_t = CIl2Cpp::__int_least32_t;
    pub type int_least64_t = CIl2Cpp::__int_least64_t;
    pub type uint_least8_t = CIl2Cpp::__uint_least8_t;
    pub type uint_least16_t = CIl2Cpp::__uint_least16_t;
    pub type uint_least32_t = CIl2Cpp::__uint_least32_t;
    pub type uint_least64_t = CIl2Cpp::__uint_least64_t;
    ...
    pub type intmax_t = CIl2Cpp::__intmax_t;
    pub type uintmax_t = CIl2Cpp::__uintmax_t;
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    ...
    pub type Il2CppProfileMethodFunc = ::std::option::Option<
        unsafe extern "C" fn(prof: *mut CIl2Cpp::Il2CppProfiler, method: *const CIl2Cpp::MethodInfo),
    >;
    ...
    pub type Il2CppProfileGCResizeFunc =
        ::std::option::Option<unsafe extern "C" fn(prof: *mut CIl2Cpp::Il2CppProfiler, new_size: i64)>;
    ...
    pub type Il2CppSetFindPlugInCallback = ::std::option::Option<
        unsafe extern "C" fn(arg1: *const CIl2Cpp::Il2CppNativeChar) -> *const CIl2Cpp::Il2CppNativeChar,
    >;
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_ZL16kIl2CppUInt64Max"]
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_ZL17kIl2CppUIntPtrMax"]
        pub static kIl2CppUIntPtrMax: usize;
    }
    pub const ipv6AddressSize: ::std::os::raw::c_int = 16;
    pub type il2cpp_hresult_t = i32;
    unsafe extern "C" {
        #[link_name = "\u{1}_ZL14kIl2CppNewLine"]
        pub static kIl2CppNewLine: [CIl2Cpp::Il2CppChar; 2usize];
    }
    ...
    pub const kIl2CppInvalidMetadataUsageAmbiguousMethod: CIl2Cpp::Il2CppInvalidMetadataUsageToken = 1;
    pub type Il2CppInvalidMetadataUsageToken = ::std::os::raw::c_uint;
    #[repr(C)]
    #[derive(Debug, Default, Copy, Clone)]
    ...
    pub const kArrayRankMask: CIl2Cpp::Il2CppMetadataTypeFlags = 4294901760;
    ...
    pub mod il2cpp {
        #[allow(unused_imports)]
        use self::super::super::CIl2Cpp;
        pub mod vm {
            #[allow(unused_imports)]
            use self::super::super::super::CIl2Cpp;
            pub mod MemoryInformation {
                #[allow(unused_imports)]
                use self::super::super::super::super::CIl2Cpp;
                pub type ClassReportFunc = ::std::option::Option<
                    unsafe extern "C" fn(
                        klass: *mut CIl2Cpp::Il2CppClass,
                        context: *mut ::std::os::raw::c_void,
                    ),
                >;
                pub type DataReportFunc = ::std::option::Option<
                    unsafe extern "C" fn(
                ...
                pub struct IterationContext {
                    pub callback: CIl2Cpp::il2cpp::vm::MemoryInformation::DataReportFunc,
        ...
        pub mod utils {
            ...
            #[repr(C)]
            #[derive(Debug, Copy, Clone)]
            pub struct StringView<CharType> {
                pub _phantom_0: ::std::marker::PhantomData<::std::cell::UnsafeCell<CharType>>,
                pub m_String: *const CharType,
                pub m_Length: usize,
            }
            impl<CharType> Default for StringView<CharType> {
                fn default() -> Self {
                    let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
                    unsafe {
                        ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    pub struct Il2CppIUnknown__bindgen_vtable(::std::os::raw::c_void);
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIUnknown {
        pub vtable_: *const Il2CppIUnknown__bindgen_vtable,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN14Il2CppIUnknown3IIDE"]
        pub static Il2CppIUnknown_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIUnknown {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppISequentialStream {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN23Il2CppISequentialStream3IIDE"]
        pub static Il2CppISequentialStream_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppISequentialStream {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIStream {
        pub _base: CIl2Cpp::Il2CppISequentialStream,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN13Il2CppIStream3IIDE"]
        pub static Il2CppIStream_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIStream {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIMarshal {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN14Il2CppIMarshal3IIDE"]
        pub static Il2CppIMarshal_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIMarshal {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIManagedObject {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN20Il2CppIManagedObject3IIDE"]
        pub static Il2CppIManagedObject_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIManagedObject {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIManagedObjectHolder {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN26Il2CppIManagedObjectHolder3IIDE"]
        pub static Il2CppIManagedObjectHolder_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIManagedObjectHolder {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIInspectable {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN18Il2CppIInspectable3IIDE"]
        pub static Il2CppIInspectable_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIInspectable {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIActivationFactory {
        pub _base: CIl2Cpp::Il2CppIInspectable,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN24Il2CppIActivationFactory3IIDE"]
        pub static Il2CppIActivationFactory_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIActivationFactory {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIRestrictedErrorInfo {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN26Il2CppIRestrictedErrorInfo3IIDE"]
        pub static Il2CppIRestrictedErrorInfo_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIRestrictedErrorInfo {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppILanguageExceptionErrorInfo {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN33Il2CppILanguageExceptionErrorInfo3IIDE"]
        pub static Il2CppILanguageExceptionErrorInfo_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppILanguageExceptionErrorInfo {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIAgileObject {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN18Il2CppIAgileObject3IIDE"]
        pub static Il2CppIAgileObject_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIAgileObject {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIWeakReference {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN20Il2CppIWeakReference3IIDE"]
        pub static Il2CppIWeakReference_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIWeakReference {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct Il2CppIWeakReferenceSource {
        pub _base: CIl2Cpp::Il2CppIUnknown,
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_ZN26Il2CppIWeakReferenceSource3IIDE"]
        pub static Il2CppIWeakReferenceSource_IID: CIl2Cpp::Il2CppGuid;
    }
    impl Default for Il2CppIWeakReferenceSource {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    pub struct PInvokeArguments {
        pub moduleName: CIl2Cpp::il2cpp::utils::StringView<CIl2Cpp::Il2CppNativeChar>,
        pub entryPoint: CIl2Cpp::il2cpp::utils::StringView<::std::os::raw::c_char>,
        pub callingConvention: CIl2Cpp::Il2CppCallConvention,
        pub charSet: CIl2Cpp::Il2CppCharSet,
        pub parameterSize: ::std::os::raw::c_int,
        pub isNoMangle: bool,
    }
    impl Default for PInvokeArguments {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    pub struct Il2CppClass {
        ...
        pub vtable: CIl2Cpp::__IncompleteArrayField<CIl2Cpp::VirtualInvokeData>,
    }
    ...
    pub struct Il2CppCodeGenOptions {
        pub enablePrimitiveValueTypeGenericSharing: bool,
    ...
    pub struct Il2CppArray {
        pub _base: CIl2Cpp::Il2CppObject,
    ...
    impl ::std::fmt::Debug for Il2CppArray {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            write!(
                f,
                "Il2CppArray {{ bounds: {:?}, max_length: {:?} }}",
                self.bounds, self.max_length
            )
        }
    }
    #[repr(C)]
    pub struct Il2CppArraySize {
        pub _base: CIl2Cpp::Il2CppArray,
        pub vector: CIl2Cpp::__IncompleteArrayField<*mut ::std::os::raw::c_void>,
    }
    ...
    impl ::std::fmt::Debug for Il2CppArraySize {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            write!(f, "Il2CppArraySize {{ vector: {:?} }}", self.vector)
        }
    }
    ...
    pub struct Il2CppString {
        ...
        pub length: i32,
        pub chars: CIl2Cpp::__IncompleteArrayField<CIl2Cpp::Il2CppChar>,
    }
    ...
    pub struct Il2CppLongLivedThreadData {
        ...
        pub synch_cs: *mut CIl2Cpp::baselib::ReentrantLock,
    }
    ...
    pub struct Il2CppInternalThread {
        ...
        pub handle: *mut CIl2Cpp::il2cpp::os::Thread,
        ...
        pub longlived: *mut CIl2Cpp::Il2CppLongLivedThreadData,
    ...
    pub struct Il2CppThread {
        ...
        pub executionContextBelongsToOuterScope: bool,
    }
    ...
    impl ::std::fmt::Debug for Il2CppException {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            write ! (f , "Il2CppException {{ className: {:?}, message: {:?}, _data: {:?}, inner_ex: {:?}, _helpURL: {:?}, trace_ips: {:?}, stack_trace: {:?}, remote_stack_trace: {:?}, remote_stack_index: {:?}, _dynamicMethods: {:?}, hresult: {:?}, source: {:?}, safeSerializationManager: {:?}, captured_traces: {:?}, native_trace_ips: {:?}, caught_in_unmanaged: {:?} }}" , self . className , self . message , self . _data , self . inner_ex , self . _helpURL , self . trace_ips , self . stack_trace , self . remote_stack_trace , self . remote_stack_index , self . _dynamicMethods , self . hresult , self . source , self . safeSerializationManager , self . captured_traces , self . native_trace_ips , self . caught_in_unmanaged)
        }
    }
    #[repr(C)]
    #[derive(Copy, Clone)]
    ...
    #[derive(Debug, Copy, Clone)]
    pub struct QICache {
        pub iid: *const CIl2Cpp::Il2CppGuid,
        pub qiResult: *mut CIl2Cpp::Il2CppIUnknown,
    }
    impl Default for QICache {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    #[repr(C)]
    #[derive(Copy, Clone)]
    pub struct Il2CppComObject {
        pub _base: CIl2Cpp::Il2CppObject,
        pub identity: *mut CIl2Cpp::Il2CppIUnknown,
        pub qiShortCache: [CIl2Cpp::QICache; 8usize],
        pub qiLongCache: *mut CIl2Cpp::QICache,
        pub qiShortCacheSize: i32,
        pub qiLongCacheSize: i32,
        pub qiLongCacheCapacity: i32,
        pub refCount: i32,
    }
    impl Default for Il2CppComObject {
        fn default() -> Self {
            let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
            unsafe {
                ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
    ...
    impl ::std::fmt::Debug for Il2CppComObject {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            write ! (f , "Il2CppComObject {{ identity: {:?}, qiShortCache: {:?}, qiLongCache: {:?}, qiShortCacheSize: {:?}, qiLongCacheSize: {:?}, qiLongCacheCapacity: {:?}, refCount: {:?} }}" , self . identity , self . qiShortCache , self . qiLongCache , self . qiShortCacheSize , self . qiLongCacheSize , self . qiLongCacheCapacity , self . refCount)
        }
    }
    ...
    pub struct Il2CppDateTimeFormatInfo {
        ...
        pub FormatFlags: i32,
        pub CultureID: i32,
        pub UseUserOverride: bool,
        pub UseCalendarInfo: bool,
        pub DataItem: i32,
        pub IsDefaultCalendar: bool,
